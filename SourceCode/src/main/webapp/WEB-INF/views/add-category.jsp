...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Fill the details below to add a new Category</p>
        </div>

        <form:form action="${pageContext.request.contextPath}/admin/category/add-category" method="post"
        ...
        <div class="form-group">
            ...
            <form:textarea path="categoryDesc" id="description" class="form-control"/>
        </div>
